...
function Home() {
  return (
    <section>
      ...
      <section>
        <div id="twitter">
          <a className="link" href="https://twitter.com/Promiseorung" target="_blank" rel="noopener noreferrer">
            Twitter Link
          </a>
        </div>
        <div id="slack">
        ...
        <div>
          <a className="link" href="https://training.zuri.team/" id="btn__zuri" target="_blank" rel="noopener noreferrer">
            Zuri Team
          </a>
        </div>
        <div>
          <a className="link" id="book__python" href="https://books.zuri.team/python-for-beginners?ref_id=magnificent" target="_blank" rel="noopener noreferrer">
            Python Books
          </a>
        </div>
        <div>
          <a className="link" href="https://background.zuri.team" id="pitch" target="_blank" rel="noopener noreferrer">
            Background Check for Coders
          </a>
        </div>
        <div>
          <a className="link" href="http://books.zuri.team" id="books" target="_blank" rel="noopener noreferrer">
            Zuri Books
          </a>
        </div>
        <div>
          <a className="link"  id="book__design" href="https://books.zuri.team/design-rules" target="_blank" rel="noopener noreferrer">
            Design Books
          </a>
        </div>
        <div>
